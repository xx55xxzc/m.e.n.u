...
#if [[ $ether = "eth0" ]]; then
#	wget -O /etc/iptables.conf "https://raw.githubusercontent.com/ForNesiaFreak/FNS_Debian7/fornesia.com/null/iptables.up.rules.eth0"
#else
#	wget -O /etc/iptables.conf "https://raw.githubusercontent.com/ForNesiaFreak/FNS_Debian7/fornesia.com/null/iptables.up.rules.venet0"
#fi
...
# download script
cd /usr/bin
wget -O /usr/bin/motd "https://raw.githubusercontent.com/fluxo7/m.e.n.u/master/method1/motd"
...
wget -O /usr/bin/menu "https://raw.githubusercontent.com/fluxo7/m.e.n.u/master/menu.sh"
...
wget -O /usr/bin/bannermenu "https://raw.githubusercontent.com/fluxo7/m.e.n.u/master/method1/bannermenu"
cd
...
wget https://raw.githubusercontent.com/fluxo7/s.c.r.i.p.t/master/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
